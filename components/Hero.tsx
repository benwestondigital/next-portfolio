...
export const Hero = () => {
  ...
  return (
    <section className="h-auto">
      <div className="flex h-4/5 animate-fadeIn md:animate-fadeInUp items-center justify-center pt-28 md:pt-32">
        ...
        <div className="mt-10 flex flex-1 flex-col md:ml-20 md:w-3/5 lg:w-1/2">
