...
const Projects = ({ projects }) => {
  return (
    <Element id='projects' name='projects'>
      <section className='my-32 flex h-auto w-full flex-col items-center justify-center'>
        <h2 className='text-5xl font-bold text-indigo-900 sm:text-6xl'>
          Projects
        </h2>
        <p className='prose my-5 text-center lg:prose-xl'>
