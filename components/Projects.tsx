...
export const Projects = ({ projects }: IProps) => (
  <Element id="projects" name="projects" className="scroll-mt-24">
    <section className="my-32 flex flex-col items-center justify-center px-2">
      ...
      <div className="mt-10 flex flex-col flex-wrap items-center justify-center gap-6 px-2 md:flex-row md:gap-10">
