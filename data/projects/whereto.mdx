...
description: 'Miss the weather in your favourite holiday destination? Let WhereTo help you decide on your next vacation spot. Built using Svelte / Svelte Kit.'
...
```typescript:components/search.svelte
	// Fetch call to Google Geocoding API get lat/long co-ords from the place id
...
// Query the database to get an array of similar cities
	try {
